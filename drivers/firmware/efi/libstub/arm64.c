...
static bool system_needs_vamap(void)
{
	 ...
	 * SetVirtualAddressMap() has not been called prior. Altra systems can
	 * be identified by the SMCCC soc ID, which is conveniently exposed via
	 * the type 4 SMBIOS records. eMAG systems all appear to have the
	 * processor version field set to "eMAG".
	 */
